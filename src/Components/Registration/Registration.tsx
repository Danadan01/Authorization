  ...
  return (
      <div className="registration-wrapper">
        <form onSubmit={regForm.handleSubmit} className="regForm">
          ...
          />
          <div className="errorDiv">
            {regForm.errors.dateOfBirth &&
              regForm.touched.dateOfBirth &&
              regForm.errors.dateOfBirth}
          </div>
          ...
          <div className="errorDiv">
            {regForm.errors.gender &&
              regForm.touched.gender &&
              regForm.errors.gender}
          </div>
          ...
          />
          <div className="errorDiv">
            {regForm.errors.copyPassword &&
              regForm.touched.copyPassword &&
              regForm.errors.copyPassword}
          </div>
